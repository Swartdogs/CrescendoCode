...
public class RobotContainer
{
    ...
    public RobotContainer()
    {
        ...
        case REAL:
            ...
            drive = new Drive(new GyroIOPigeon2(), new ModuleIOSparkMax(0), new ModuleIOSparkMax(1),
        ...
        autoChooser.addOption("Drive FF Characterization", new FeedForwardCharacterization(drive,
                        drive::runCharacterizationVolts, drive::getCharacterizationVelocity));
