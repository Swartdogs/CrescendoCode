...
public class ClimbIOSparkMax implements ClimbIO {
  ...
  public void updateInputs(ClimbIOInputs inputs) {
    ...
    inputs.appliedVoltsLeft =
        _climbSparkMaxLeft.getAppliedOutput() * _climbSparkMaxLeft.getBusVoltage();
    inputs.appliedVoltsRight =
        _climbSparkMaxRight.getAppliedOutput() * _climbSparkMaxRight.getBusVoltage();
