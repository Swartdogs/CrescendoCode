...
public final class Constants
{
    ...
    public static class ShooterBed // FIXME: Update all these values
    {
        ...
        public static final Rotation2d BED_PODIUM_SHOT_ANGLE    = Rotation2d.fromDegrees(38);
        public static final Rotation2d BED_AMP_SHOT_ANGLE       = Rotation2d.fromDegrees(26);
