...
public final class Constants {
  ...
  public static class Drive {
    ...
    public static final Rotation2d MODULE_FL_OFFSET = Rotation2d.fromRadians(-0.69);
    public static final Rotation2d MODULE_FR_OFFSET = Rotation2d.fromRadians(1.04);
    public static final Rotation2d MODULE_BL_OFFSET = Rotation2d.fromRadians(-0.86);
    public static final Rotation2d MODULE_BR_OFFSET = Rotation2d.fromRadians(-1.58);
  }
