...
public class RobotContainer
{
    ...
    private void configureButtonBindings()
    {
        ...
        _controller.leftBumper().whileTrue(ClimbCommands.setVoltage(_climb, () -> -_controller.getLeftY(), () -> -_controller.getRightY()).alongWith(CompositeCommands.LEDSetSolidColor(_led, Constants.LED.PINK)).finallyDo(() -> _climb.stop()));
