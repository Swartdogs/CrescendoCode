...
public final class Constants
{
    ...
    public static class CAN
    {
        ...
        public static final int     MODULE_FR_DRIVE     = 5;
        public static final int     MODULE_FR_ROTATE    = 6;
        public static final int     MODULE_BL_DRIVE     = 3;
        public static final int     MODULE_BL_ROTATE    = 4;
    ...
    public static class AIO
    {
        ...
        public static final int     MODULE_FR_SENSOR    = 3;
        public static final int     MODULE_BL_SENSOR    = 1;
        public static final int     MODULE_BR_SENSOR    = 2;
    }
    ...
    public static class Drive
    {
        ...
        public static final double  MODULE_FL_OFFSET    = 0;
        public static final double  MODULE_FR_OFFSET    = 0;
        public static final double  MODULE_BL_OFFSET    = 0;
        public static final double  MODULE_BR_OFFSET    = 0;
    }
