...
public class ModuleIOSparkMax implements ModuleIO
{
    ...
    private final DutyCycleEncoder  _turnAbsoluteEncoder;

    private final boolean           _isTurnMotorInverted = true;
    private final Rotation2d        _absoluteEncoderOffset;

    public ModuleIOSparkMax(int driveCanId, int turnCanId, int absoluteEncoderChannel, double absoluteEncoderOffset)
    {
        ...
        _turnAbsoluteEncoder    = new DutyCycleEncoder(absoluteEncoderChannel);
    ...
    public void updateInputs(ModuleIOInputs inputs)
    {
        ...
        inputs.turnAbsolutePosition     = new Rotation2d(_turnAbsoluteEncoder.getAbsolutePosition() * 2.0 * Math.PI).minus(_absoluteEncoderOffset);
