...
public class ModuleIOHardware implements ModuleIO {
  ...
  public ModuleIOHardware(
    ...
    _turnAbsoluteEncoder =
        new AnalogPotentiometer(
            absoluteEncoderChannel,
            Constants.Drive.HALL_EFFECT_SCALE,
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        50.0, _driveVelocity, _driveAppliedVolts, _driveCurrent);
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnAbsolutePosition =
        Rotation2d.fromDegrees(
            Math.IEEEremainder(
                _turnAbsoluteEncoder.get() - _absoluteEncoderOffset.getDegrees(), 360));
    inputs.turnPosition =
